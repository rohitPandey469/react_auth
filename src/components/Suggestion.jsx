  ...
  return (
    <>
      <div className="Header d-flex justify-content-between">
        ...
        <button
          className="btn"
          style={{ width: "auto", backgroundColor: "#40916C" }}
        >
          See more
        </button>
      </div>
        ...
        <ul class=" ulist d-flex text-center" style={{ listStyle: "none" }}>
          <li>
            ...
            >
              ...
              <div class="col">
                <img src={Ashw} alt="" />
                <span className="text-white">Ashwagandha</span> <span></span>
              </div>
            </a>
          </li>
          <li>
            ...
            >
              <div class="col">
                <img src={Brahmi} alt="" />
                <span className="text-white">Brahmi</span> <span></span>
              </div>
            </a>
          </li>
          <li>
            ...
            >
              <div class="col">
                <img src={Mintoil} alt="" />
                <span className="text-white">Peppermint oil</span> <span></span>
              </div>
            </a>
          </li>
          <li>
            ...
            >
              <div class="col">
                <img src={Shank} alt="" />
                <span className="text-white">Shankpushpi</span> <span></span>
              </div>
            </a>
          </li>
          <li>
            ...
            >
              <div class="col">
                <img src={Trip} alt="" />
                <span className="text-white">Triphula </span> <span></span>
              </div>
            </a>
          </li>
        </ul>
